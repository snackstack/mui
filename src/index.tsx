...
import { SnackRendererProps } from '@snackstack/core/dist/types/SnackRendererProps';
...
export const DefaultTransitionComponent = (
  anchorOrigin: SnackbarOrigin
): SnackbarProps['TransitionComponent'] => props => (
  <Slide {...props} direction={getTransitionDirection(anchorOrigin)} />
);

interface MaterialSnackRendererProps extends SnackRendererProps {
